        ...
        <div className ='w-full h-screen text-center'>
            <div className = 'max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                <div>
                    ...
                    <span className='text-[#5651e5]'> Jay Pathak</span></h1>
                    <h1 className='py-2 text-gray-700'>A Web-Developer</h1>
                    <p className='py-4 text-gray-600 max-w-[70%] m-auto'>
                    I am a passionate and dedicated web developer with a keen interest in creating innovative and interactive websites.
