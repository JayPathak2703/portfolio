  ...
  return (
    <div className="w-full h-screen text-center">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          <p className="uppercase text:sm tracking-widest text-grey-600 text-bold ">
            Getting To Know Me !
          </p>
          ...
          <p className="py-4 text-gray-600 max-w-[70%] m-auto">
            I&apos;m a passionate and dedicated web developer with a keen
            interest in creating innovative and interactive websites. I love
            exploring new technologies and frameworks to enhance my skills and
